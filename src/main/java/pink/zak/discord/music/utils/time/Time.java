package pink.zak.discord.music.utils.time;
...
public class Time {
    ...
    public static String formatShort(Duration duration) {
        ...
        if (millis >= TimeIdentifier.MONTH.getMilliseconds())
            return millis / TimeIdentifier.MONTH.getMilliseconds() + "mo ago";
        if (millis >= TimeIdentifier.WEEK.getMilliseconds())
            return millis / TimeIdentifier.WEEK.getMilliseconds() + "w ago";
        if (millis >= TimeIdentifier.DAY.getMilliseconds())
            return millis / TimeIdentifier.DAY.getMilliseconds() + "d ago";
        if (millis >= TimeIdentifier.HOUR.getMilliseconds())
            return millis / TimeIdentifier.HOUR.getMilliseconds() + "h ago";
        if (millis >= TimeIdentifier.MINUTE.getMilliseconds())
            return millis / TimeIdentifier.MINUTE.getMilliseconds() + "m ago";
        return millis / TimeIdentifier.SECOND.getMilliseconds() + "s ago";
    }
